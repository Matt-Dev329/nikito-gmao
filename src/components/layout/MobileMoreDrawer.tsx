...
const pilotageItems: DrawerItem[] = [
  { to: '/gmao/equipements', label: 'Equipements', iconLabel: 'Équipements', roles: ['direction', 'chef_maintenance', 'directeur_parc', 'technicien', 'manager_parc', 'admin_it'] },
  { to: '/gmao/ia-predictive', label: 'IA Predictive', iconLabel: 'IA Prédictive', roles: ['direction', 'chef_maintenance', 'directeur_parc', 'admin_it'] },
  ...
  { to: '/gmao/controles-historique', label: 'Historique controles', iconLabel: 'Contrôles', roles: ['direction', 'chef_maintenance', 'directeur_parc', 'admin_it'] },
];

const configItems: DrawerItem[] = [
  { to: '/gmao/parcs', label: 'Parcs', iconLabel: 'Parcs', roles: ['direction', 'chef_maintenance', 'directeur_parc', 'admin_it'] },
  { to: '/gmao/utilisateurs', label: 'Utilisateurs', iconLabel: 'Utilisateurs', roles: ['direction', 'chef_maintenance', 'directeur_parc', 'manager_parc', 'admin_it'] },
  { to: '/gmao/bibliotheque', label: 'Bibliotheque points', iconLabel: 'Bibliothèque points', roles: ['direction', 'chef_maintenance', 'directeur_parc', 'admin_it'] },
  { to: '/gmao/fournisseurs', label: 'Fournisseurs', iconLabel: 'Fournisseurs', roles: ['direction', 'chef_maintenance', 'directeur_parc', 'admin_it'] },
...
const accountItems: DrawerItem[] = [
  { to: '/gmao/profil', label: 'Profil', iconLabel: 'Utilisateurs', roles: ['direction', 'chef_maintenance', 'directeur_parc', 'manager_parc', 'technicien', 'staff_operationnel', 'admin_it'] },
  { to: '/gmao/aide', label: 'Aide', iconLabel: 'Aide', roles: ['direction', 'chef_maintenance', 'directeur_parc', 'manager_parc', 'technicien', 'staff_operationnel', 'admin_it'] },
];
