      ...
      <header className="bg-bg-card border-b border-white/[0.06] px-7 pt-5 pb-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="bg-gradient-cta text-text px-5 py-2.5 rounded-xl text-[13px] font-semibold"
          >
            + Ajouter
          </button>
        </div>
          ...
          <div className="flex flex-col gap-3">
            {attractions.map((a) => {
              ...
              return (
                <div
                  key={a.id}
                  className="bg-bg-card rounded-xl p-4 px-5 border border-white/[0.06] flex items-center gap-4"
                >
                    ...
                    {isConfirm ? (
                      <div className="flex gap-1.5">
                        <button
                          ...
                          className="px-3 py-1.5 rounded-lg bg-red/15 text-red text-[11px] font-semibold"
                        >
                          Confirmer
                        </button>
                        <button
                          onClick={() => setConfirmSuppr(null)}
                          className="px-3 py-1.5 rounded-lg bg-bg-deep text-dim text-[11px]"
                        >
                          Annuler
                        </button>
                      </div>
                      ...
                      <button
                        ...
                        className="w-8 h-8 rounded-lg bg-bg-deep border border-white/[0.08] text-red/60 hover:text-red text-sm transition-colors"
                      >
                        x
                      </button>
                    )}
